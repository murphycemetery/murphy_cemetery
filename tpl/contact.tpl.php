...
<html lang="en">
<head>
  <meta name="description" content="Murphy Cemetery Contact">
  <meta name="keywords" content="Murphy Cemetery, contact, cemetery">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Contact Us Murphy Cemetery</title>
...
<body>
    ...
    <h1 class="contact-head">Come find us for more information!</h1>
        ...
        <span class="confirmation-message"><h1><?php echo $msg ?></h1></span>
        ...
        <form id="contact-form" name="contact-form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <li class="col1">
                ...
                <input type="text" id="firstName" name="firstName" value="<?php echo $firstName ?>"><span class="<?php echo $msgClass ?>"><br><?php echo $firstNameError ?></span>
            </li>

            <li class="col1">
                <label for="lastName">Last Name <span class="form-required">*</span></label>
                <input type="text" id="lastName" name="lastName" value="<?php echo $lastName ?>"><span class="<?php echo $msgClass ?>"><br><?php echo $lastNameError ?></span>
            </li>
            ...
            <li class="col2">
                ...
                <input type="email" id="email" name="email" value="<?php echo $email ?>"><span class="<?php echo $msgClass ?>"><br><?php echo $emailError ?></span>
            </li>

            <li class="col2">
                <label for="phone">Phone Number <span class="form-required">*</span></label>
                <input type="tel" id="phone" name="phone" placeholder="712-221-5827" value="<?php echo $phone ?>"><span class="<?php echo $msgClass ?>"><br><?php echo $phoneError ?></span>
            </li>
            ...
            <li>
                ...
                <textarea id="message" name="message"><?php echo $message ?></textarea><span class="<?php echo $msgClass ?>"><br><?php echo $messageError ?></span>
