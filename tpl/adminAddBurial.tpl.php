...
<head>
    ...
    <script
        ...
        <title>Add Burial Murphy Cemetery</title>
...
<body>
    <div id="displayArea">
        ...
        <div class="formStyle">
            <form method="post" name="submitBurial" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" enctype="multipart/form-data">
                ...
                <div class="inputCols2">
                    ...
                    <input type="date" name="birthDate" value="<?php if(!$birthDate == "") echo $birthDate ?>" placeholder="<?php echo $birthDateERR ?>"/>
                </div>
                <div class="inputCols2">
                    <div class="labelDesc">
                ...
                <div class="inputCols2">
                    ...
                    <input type="date" name="deathDate" value="<?php echo $deathDate ?>" placeholder="<?php echo $deathDateERR ?>"/>
                </div>
                ...
                <div class="inputCols2">
                    ...
                    <input type="date" name="intermentDate" value="<?php echo $intermentDate ?>" placeholder="<?php echo $intermentDateERR ?>"/>
                </div>
                <div class="inputCols2">
                    <div class="labelDesc">
                ...
                <div class="inputCols3">
                    <label>Veteran</label>
                    <input id="veteran" type="checkbox" name="veteran" value="y" <?php if ($veteran == "veteran") echo "checked"; ?>/>
                </div>
                <div class="inputCols3">
