<html>
  <head>
    <meta charset="UTF-8">
    <meta name="description" content="Murphy Cemetery Saved">
    <meta name="keywords" content="Murphy Cemetery, saved, cemetery">
  ...
  <body>
    <div id="container">
      <h1>Burial was saved!</h1>
          <a href="adminIndex.php"><button>Back to Admin Home</button></a>
    </div>
  </body>
  <footer>
